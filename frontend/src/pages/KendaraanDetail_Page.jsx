            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 m-4">
                ...
                <div className="lg:col-span-1 bg-white p-4 border rounded-lg shadow-md flex flex-col justify-between h-full">
                    <div className="grid grid-cols-2 gap-4 flex-1">
                        <div>
                            <p className="text-cyan-600 text-xs lg:text-base font-bold">No Kendaraaan</p>
                            <p className="text-gray-600 text-xs lg:text-base">{vehicle.no_kendaraan}</p>
                        </div>
                        <div>
                            <p className="text-cyan-600 text-xs lg:text-base font-bold">ID Perangkat</p>
                            <p className="text-gray-600 text-xs lg:text-base">{vehicle.id_perangkat}</p>
                        </div>
                        <div>
                            <p className="text-cyan-600 text-xs lg:text-base font-bold">Kategori</p>
                            <p className="text-gray-600 text-xs lg:text-base">{vehicle.kategori}</p>
                        </div>
                        <div>
                            <p className="text-cyan-600 text-xs lg:text-base font-bold">Driver</p>
                            <p className="text-gray-600 text-xs lg:text-base">{vehicle.driver}</p>
                        </div>
                        <div>
                            <p className="text-cyan-600 text-xs lg:text-base font-bold">Update Terakhir</p>
                            <p className="text-gray-600 text-xs lg:text-base">{vehicle.last_update}</p>
                        </div>
                        <div>
                            <p className="text-cyan-600 text-xs lg:text-base font-bold">Operator</p>
                            <p className="text-gray-600 text-xs lg:text-base">{vehicle.operator}</p>
                        </div>
                        <div>
                            <p className="text-cyan-600 text-xs lg:text-base font-bold">No Telepon</p>
                            <p className="text-gray-600 text-xs lg:text-base">{vehicle.no_telepon}</p>
                        </div>
                        <div>
                            <p className="text-cyan-600 text-xs lg:text-base font-bold">Mesin</p>
                            <p className="text-gray-600 text-xs lg:text-base">
                                {vehicle.detail?.engineStatus || ""}
                            </p>
                        </div>
                        <div>
                            <p className="text-cyan-600 text-xs lg:text-base font-bold">Kondisi</p>
                            <p className="text-gray-600 text-xs lg:text-base">{vehicle.detail?.status || ""}</p>
                        </div>
                        <div>
                            <p className="text-cyan-600 text-xs lg:text-base font-bold">Kecepatan</p>
                            <p className="text-gray-600 text-xs lg:text-base">{vehicle.detail?.speed || ""}</p>
                        </div>
                        <div>
                            <p className="text-cyan-600 text-xs lg:text-base font-bold">Longitude</p>
                            <p className="text-gray-600 text-xs lg:text-base">
                                {vehicle.detail?.coordinate.longitude || ""}
                            </p>
                        </div>
                        <div>
                            <p className="text-cyan-600 text-xs lg:text-base font-bold">Latitude</p>
                            <p className="text-gray-600 text-xs lg:text-base">
                                {vehicle.detail?.coordinate.latitude || ""}
                            </p>
                        </div>
                        <div>
                            <p className="text-cyan-600 text-xs lg:text-base font-bold">Jenis Paket</p>
                            <p className="text-gray-600 text-xs lg:text-base">{vehicle.subscription?.type || ""}</p>
                        </div>
                        <div>
                            <p className="text-cyan-600 text-xs lg:text-base font-bold">Paket Berakhir</p>
                            <p className="text-gray-600 text-xs lg:text-base">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 mt-auto">
                        <Button onClick={() => navigate(`/kendaraan/${vehicle.id}/edit`)} className="bg-cyan-600">
                            <p>
                    ...
                    <div className="grid grid-rows-3 lg:grid-cols-3 lg:grid-rows-1 bg-white p-4 rounded-lg shadow-md min-h-[300px] gap-4">
                        ...
                        <div className="row-span-1 lg:col-span-1 flex flex-col items-center justify-center text-lg font-bold text-cyan-600 rounded-lg py-6 px-14 space-y-4">
                            ...
                            <div className="w-full relative">
                                <div className="bg-gray-200 text-center text-gray-700 text-xs font-mono rounded-md py-2 px-3 cursor-pointer flex items-center justify-center gap-2" onClick={handleSortDate}>
                                    <div className="mr-4">14 Oct 2024</div>
                                    <img
                                        src={Arrow}
                                        alt="Arrow"
                                        className={`w-3 h-3 transition-transform duration-500 ${isSortDate ? "rotate-90" : "rotate-[270deg]"}`}
                                    />
                                </div>
                                {isSortDate && (
                                    <div className="absolute left-0 mt-2 bg-white border border-gray-300 rounded-md shadow-md p-2 z-50 w-full">
                                        <ul className="text-gray-700 text-xs text-center">
                                            <li className="py-1 px-2 hover:bg-gray-100 cursor-pointer">13 Oct 2024</li>
                                            <li className="py-1 px-2 hover:bg-gray-100 cursor-pointer">12 Oct 2024</li>
                                            <li className="py-1 px-2 hover:bg-gray-100 cursor-pointer">11 Oct 2024</li>
                                        </ul>
                                    </div>
                                )}
                            </div>
